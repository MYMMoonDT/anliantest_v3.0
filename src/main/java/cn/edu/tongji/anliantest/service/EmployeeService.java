...
public interface EmployeeService {
	...
	public DataWrapper<Employee> updateEmployeeAuthorityGroup(Long employeeId, Long authorityGroupId);
	
	public DataWrapper<Void> updateEmployeeAuthorityItem(EmployeeAuthorityItem employeeAuthorityItem);
}
