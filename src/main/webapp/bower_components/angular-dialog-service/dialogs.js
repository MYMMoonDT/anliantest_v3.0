...
angular.module('dialogs.services',['ui.bootstrap.modal','dialogs.controllers'])
	...
	.provider('dialogs',[function(){
		...
		var _setOpts = function(opts){
			...
			_opts.ws = (angular.isDefined(opts.size) && (angular.equals(opts.size,'sm') || angular.equals(opts.size,'lg') || angular.equals(opts.size,'md') || angular.equals(opts.size,'sg'))) ? opts.size : _wSize; // values: 'sm', 'lg', 'md'
		...
		this.setSize = function(val){
			if(angular.isDefined(val))
				_wSize = (angular.equals(val,'sm') || angular.equals(val,'lg') || angular.equals(val,'md') || angular.equals(val,'sg')) ? val : _wSize;
		}; // end setSize
